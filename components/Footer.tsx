    ...
    <footer style={{ background: "#0D0D0D", color: "rgba(255,255,255,0.45)" }}>
      <div className="max-w-[1280px] mx-auto px-5 md:px-8 pt-16 pb-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 pb-12 border-b border-[rgba(255,255,255,0.08)]">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <div className="flex gap-2">
              <a href="https://www.linkedin.com/company/kreative-tech-official/?viewAsMember=true" target="_blank" rel="noopener noreferrer"
              ...
              <a href="mailto:connect@kreativetech.in"
          ...
          <div>
            ...
            <ul className="space-y-3 list-none p-0 m-0">
              <li>
                <a href="tel:+919082706169" className="text-sm text-[rgba(255,255,255,0.45)] hover:text-white transition-colors">
                  +91 90827 06169
                </a>
              </li>
              <li>
                <a href="mailto:connect@kreativetech.in" className="text-sm text-[rgba(255,255,255,0.45)] hover:text-white transition-colors">
                  connect@kreativetech.in
                </a>
              </li>
        ...
        <div className="pt-6 flex flex-col sm:flex-row justify-between items-center gap-3 text-xs text-[rgba(255,255,255,0.3)]">
          <span>© 2026 Kreative Tech. All rights reserved.</span>
