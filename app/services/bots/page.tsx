    ...
    <>
      ...
      <section className="pt-16 bg-[#F7F4EE]">
        <div className="max-w-[1280px] mx-auto px-5 md:px-8 py-14 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <FadeUp delay={0.1}>
            <VideoPlayer
              gradientFrom="rgba(37,211,102,0.4)"
              title="WhatsApp Bot — Live Walkthrough"
              subtitle="See a real bot conversation"
              badge="▶ Watch Demo"
            />
          </FadeUp>
        </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1280px] mx-auto px-5 md:px-8">
          <FadeUp className="mb-12">
            ...
            <h2 className="text-[clamp(26px,2.8vw,36px)] font-bold text-[#141414] tracking-[-0.8px]" style={syne}>Bots We&apos;ve Built</h2>
          </FadeUp>
