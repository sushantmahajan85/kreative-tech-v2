...
const heroStats: Array<{ val?: string; to?: number; suffix?: string; lbl: string }> = [
  { val: "₹15,000+", lbl: "Starting Price" },
  { val: "3–7 Days", lbl: "Go-live" },
  { to: 20, suffix: "+", lbl: "Bots Built" },
];

const features = [
  { icon: "💬", title: "WhatsApp Business API", desc: "Official WhatsApp Business API integration with automated replies, message templates, broadcast lists, and full conversation management." },
  { icon: "🤖", title: "Telegram Bots", desc: "Custom Telegram bots with command menus, inline keyboards, payment integrations, group management, and webhook-based real-time responses." },
  { icon: "📥", title: "Lead Capture & Qualification", desc: "Automated lead capture flows that collect contact details, qualify prospects with smart questions, and push data straight to your CRM or Google Sheets." },
  { icon: "🛒", title: "Order Notifications & Updates", desc: "Trigger WhatsApp messages for order confirmations, shipping updates, payment receipts, and delivery alerts — automatically from your e-commerce platform." },
  { icon: "🧠", title: "AI-Powered Auto-Responses", desc: "GPT-powered chatbots that understand natural language, answer FAQs, handle objections, and escalate to a human agent when needed." },
  { icon: "📊", title: "Analytics & Reporting", desc: "Message delivery rates, open rates, response rates, and conversation funnel analytics — all in a simple dashboard so you know what is working." },
];
...
const faqs = [
  { q: "Do I need a WhatsApp Business account?", a: "Yes. We handle the full WhatsApp Business API application process on your behalf — most approvals take 2–5 business days. Your existing number can be migrated in most cases." },
  { q: "Can the bot handle payments?", a: "Yes. WhatsApp Pay (India) and Razorpay payment links can be sent directly in the chat. For Telegram, we integrate Razorpay, PayU, and Telegram Payments natively." },
  { q: "How is this different from a basic auto-reply?", a: "Auto-replies are static. Our bots understand conversation context, branch based on user responses, integrate with your CRM and order systems, and can hand off to a human agent mid-conversation." },
  { q: "Will the bot understand Hindi and regional languages?", a: "Yes. We can build bots that understand and respond in Hindi, Hinglish, Tamil, Telugu, or any other language your customers use." },
  { q: "What happens if the bot can't answer a question?", a: "We set up a fallback flow — the bot acknowledges it cannot help, collects the user's query, and assigns the conversation to a human agent with full chat history visible." },
];
    ...
    <>
      ...
      <section className="pt-16 bg-[#F7F4EE]">
        <div className="max-w-[1280px] mx-auto px-5 md:px-8 py-14 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <FadeUp>
            <div className="inline-flex items-center gap-2 bg-[#E8F5EE] text-[#1A7A4A] rounded-full px-4 py-1.5 text-xs font-semibold mb-6">
              <span className="w-1.5 h-1.5 rounded-full bg-[#25D366]" /> WhatsApp & Telegram Bots
            </div>
            <h1 className="text-[clamp(36px,5vw,56px)] font-extrabold leading-[1.1] tracking-[-1.5px] text-[#141414] mb-5" style={syne}>
              Bots That <em className="not-italic text-[#E8561A]">Sell While You Sleep</em>
            </h1>
            <p className="text-lg text-[#5A5A5A] font-light leading-[1.75] mb-8 max-w-2xl">
              Custom WhatsApp and Telegram bots for lead capture, order updates, customer support, and AI-powered conversations. Automate customer communication at scale.
            </p>
          ...
          <FadeUp delay={0.1}>
            <div className="relative w-full aspect-video bg-[#141414] rounded-2xl overflow-hidden cursor-pointer group"
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-[rgba(37,211,102,0.4)] to-[rgba(20,20,20,0.78)] flex flex-col items-center justify-center gap-3 group-hover:opacity-90 transition-opacity">
                ...
                <div className="text-center">
                  <div className="text-white font-semibold text-sm">WhatsApp Bot — Live Walkthrough</div>
                  <div className="text-white/60 text-xs mt-1">See a real bot conversation</div>
                </div>
              </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1280px] mx-auto px-5 md:px-8">
          <FadeUp className="text-center mb-12">
            ...
            <h2 className="text-[clamp(26px,2.8vw,36px)] font-bold text-[#141414] tracking-[-0.8px]" style={syne}>Everything in One Bot</h2>
          </FadeUp>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-3xl mx-auto px-5 md:px-8">
          <FadeUp className="text-center mb-10">
            <h2 className="text-[clamp(24px,2.5vw,32px)] font-bold text-[#141414] tracking-[-0.8px]" style={syne}>Bot FAQs</h2>
          </FadeUp>
        ...
        <div className="max-w-2xl mx-auto px-5 md:px-8 text-center">
          <FadeUp>
            <h2 className="text-[clamp(28px,3vw,40px)] font-extrabold text-white tracking-[-0.8px] mb-4" style={syne}>
              Ready to <span className="text-[#E8561A]">Automate Customer Chat?</span>
            </h2>
            <p className="text-[rgba(255,255,255,0.55)] font-light mb-8">Tell us your use case. We&apos;ll build a bot that captures leads, answers questions, and converts — 24/7 without any manual effort.</p>
            <a href={WA} target="_blank" rel="noopener noreferrer"
