...
const portfolio = allProjects.projects.filter((p) => p.categories.includes("cloud-devops"));
    ...
    <>
      ...
      <section className="pt-16 bg-[#F7F4EE]">
        <div className="max-w-[1280px] mx-auto px-5 md:px-8 py-14 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <FadeUp delay={0.1}>
            <VideoPlayer
              gradientFrom="rgba(26,78,232,0.5)"
              title="Cloud & DevOps — See It in Action"
              subtitle="Watch a live pipeline demo"
              badge="▶ Watch Demo"
            />
          </FadeUp>
        </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1280px] mx-auto px-5 md:px-8">
          <FadeUp className="mb-12">
            ...
            <h2 className="text-[clamp(26px,2.8vw,36px)] font-bold text-[#141414] tracking-[-0.8px]" style={syne}>Cloud Projects We&apos;ve Delivered</h2>
          </FadeUp>
