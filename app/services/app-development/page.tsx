...
const portfolio = [
  ...
  { title: "Grabzy Platform", desc: "On-demand service app with live tracking, push notifications, and multi-vendor support.", image: "/images/grabzy.JPG", tag: "Mobile App", link: "#" },
  { title: "Grocery Delivery App", desc: "Hyperlocal grocery delivery app with real-time inventory, slot booking, and UPI checkout.", color: "#1A3A5C", tag: "Flutter App" },
  { title: "Fitness Tracker App", desc: "Workout tracking app with custom exercise plans, progress charts, and streak rewards.", color: "#2D1B4A", tag: "iOS + Android" },
  { title: "Restaurant Booking App", desc: "Table reservation system with menu browsing, pre-ordering, and loyalty points.", color: "#3A1A1A", tag: "React Native" },
  { title: "EdTech Learning App", desc: "Video course platform with offline downloads, quiz engine, and certificate generation.", color: "#0D2137", tag: "Flutter App" },
];
        ...
        <div className="max-w-[1280px] mx-auto px-5 md:px-8 py-20 md:py-28">
          <FadeUp className="max-w-3xl">
            ...
            <div className="flex flex-wrap gap-6">
              {[["₹60,000+", "Starting Price"], ["4–8 Weeks", "Delivery Time"], ["20+", "Apps Launched"], ["Both Platforms", "iOS + Android"]].map(([val, lbl]) => (
                <div key={lbl}>
      ...
      <section className="py-20 bg-[#F7F4EE]">
        <div className="max-w-4xl mx-auto px-5 md:px-8 text-center">
          <FadeUp>
            ...
            <h2 className="text-[clamp(24px,2.8vw,34px)] font-bold text-[#141414] tracking-[-0.8px] mb-8" style={syne}>Watch a Full App Build — Design to Launch</h2>
            <div className="relative w-full aspect-video bg-[#141414] rounded-2xl overflow-hidden cursor-pointer group"
              ...
              <div className="absolute bottom-5 left-5 bg-[rgba(255,255,255,0.12)] backdrop-blur-sm border border-[rgba(255,255,255,0.2)] rounded-xl px-4 py-2.5 text-white text-left">
                <div className="text-sm font-semibold">Buki Vista — From Wireframe to Play Store</div>
                <div className="text-xs opacity-70 mt-0.5">Complete app development walkthrough</div>
              </div>
            </div>
            <p className="text-sm text-[#5A5A5A] mt-4 font-light">Replace with your own app project video</p>
          </FadeUp>
        </div>
      </section>
                ...
                {(p.link && p.link !== "#") ? (
                  <a href={p.link} target="_blank" rel="noopener noreferrer"
                    ...
                    <div className="p-5">
                      ...
                      <div className="flex items-center gap-1 mt-3 text-xs font-semibold text-[#E8561A]">View on Play Store →</div>
                    </div>
                  </a>
                ) : (
                  <div className="bg-[#F7F4EE] border border-[rgba(20,20,20,0.08)] rounded-2xl overflow-hidden h-full">
                    <div className="relative h-48 flex items-center justify-center" style={{ background: p.color }}>
                      ...
                      {!p.image && <div className="text-3xl font-extrabold text-white/15" style={syne}>{p.title.split(" ")[0].toUpperCase()}</div>}
                      <div className="absolute top-3 left-3 bg-[rgba(255,255,255,0.15)] backdrop-blur-sm border border-[rgba(255,255,255,0.2)] text-white text-xs font-semibold px-2.5 py-1 rounded-full">{p.tag}</div>
                      <div className="absolute top-3 right-3 bg-[rgba(20,20,20,0.4)] text-white/70 text-xs px-2.5 py-1 rounded-full">NDA</div>
                    </div>
                    <div className="p-5">
                      <h3 className="font-bold text-[#141414] mb-1" style={syne}>{p.title}</h3>
                      <p className="text-sm text-[#5A5A5A] font-light">{p.desc}</p>
